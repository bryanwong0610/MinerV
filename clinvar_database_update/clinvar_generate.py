...
def clinvaravinput2annovardb(avinput_file, fields):
    annovar_db = '#Chr\tStart\tEnd\tRef\tAlt\tCLNALLELEID\tCLNDN\tCLNDISDB\tCLNREVSTAT\tCLNSIG\tCLNHGVS\n'
...
if __name__ == '__main__':
    ...
    clinvaravinput2annovardb(
        '/mnt/datashare/home/wangzesong/clinvar/hg19_build/GRCh37_clinvar_20220719.avinput',
        ['ALLELEID', 'CLNDN', 'CLNDISDB', 'CLNREVSTAT', 'CLNSIG','CLNHGVS']
    )