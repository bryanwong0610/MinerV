...
outputs:
  - id: filter_res
    ...
    type: File?
    'sbg:x': 1745.7239990234375
    'sbg:y': 128.17324829101562
  - id: unfilter_res
    outputSource:
      - api_filter_annovar_res_r/unfilter_res
    type: File?
    'sbg:x': 1778.9215087890625
    'sbg:y': -387.9404296875
  - id: output_1
    outputSource:
...
steps:
  - id: geneanno
    ...
    label: geneAnno
    'sbg:x': 1280.2073974609375
    'sbg:y': 249.37615966796875
          ...
          listing:
            - entryname: Filter.R
              entry: >-
                ...
                select_col <-
                c("Chr","Start","End","Variation_detail","GENEINFO","Gene.refGene","Func.refGene","ExonicFunc.refGene","GeneDetail.refGene", # Gene
                                "AAChange.refGene","Gene.ensGene","Func.ensGene","ExonicFunc.ensGene","GeneDetail.ensGene","AAChange.ensGene", # Function
                                "HGVS","EXOMISER_VARIANT_SCORE","EXOMISER_GENE_PHENO_SCORE(AD)","EXOMISER_GENE_VARIANT_SCORE(AD)","EXOMISER_GENE_COMBINED_SCORE(AD)",
                                ...
                                "EXOMISER_GENE_VARIANT_SCORE(MT)","EXOMISER_GENE_COMBINED_SCORE(MT)","geneId","geneSymbol","hgncId","hgncSymbol","entrezId","ensemblId","ucscId","combinedScore","priorityScore","variantScore","Diseases","exomiserRank", # Exomiser_result
                                ...
                                "OMIM_Phenotype","HPO_phenotype", #OMIM&HPO
              ...
              writable: false
    label: api_filter_annovar_res.R
    'sbg:x': 1629.1331787109375
    'sbg:y': -139.91883850097656
  - id: tabix
    in:
      - id: GZ_Sorted_VCF
        source: bgzip/gz_vcf
